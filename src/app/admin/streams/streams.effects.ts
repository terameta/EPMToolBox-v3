...
import { Load, Create, Clone, Update, Delete } from './streams.actions';
...
export class StreamEffects {
	...
	constructor( private actions$: Actions, private service: StreamsService, private store: Store<AppState> ) { }
}
