...
export class Initiator {
	...
	private prepareSteps = () => {
		...
		// 			}
		// 		} );
		// this.steps.push( { expectedCurrentVersion: 99,
		// operatorFunction: () => this.db.query( 'ALTER TABLE streams DROP name, DROP type, DROP environment, DROP dbName, DROP tableName, DROP customQuery, DROP tags, DROP exports' )
		// } );
